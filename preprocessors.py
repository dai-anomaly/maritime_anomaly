...
class BasePreprocessor:
    ...
    def get_feature_indices(self, cols):
        if self.feature_names is None:
            raise ValueError("Feature names not initialized yet")
        return [self.feature_names.index(c) for c in cols if c in self.feature_names]
